  ...
  <?php if ($linked_logo_img || $site_name || $site_slogan): ?>
    <div class="branding-data clearfix">
      ...
      <?php if($show_isu_nameplate): ?>
        <div id="isu_wordmark">
          <a accesskey="1" class="nameplate" href="http://www.iastate.edu" title="Iowa State University Homepage"><img src="<?php print path_to_theme(); ?>/images/sprite.png" alt="Iowa State University"></a>
        </div>
      <?php endif; ?>
