    ...
    Drupal.behaviors.suitcaseSidebarMenu = {
        attach: function (context) {
            $('body', context).once('suitcaseSidebarMenu', function() {
                ...
                // Close Button
                $sidebarmenu.append('<img src="' + Drupal.settings.basePath + 'sites/all/themes/suitcase/suitcase_classic/images/close-button-white.png" id="side-menu-close-button" style="top: ' + top + 'px">');
